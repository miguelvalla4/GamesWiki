...
class ViewGamesByCompanyIdUseCaseTest extends TestCase
{
     ...
     * @throws Exception
     */
    public function testFailWhenGameReleasedAfterNow()
    {
        self::expectException(DomainException::class);
        self::expectExceptionMessage('La fecha es mayor que el momento presente.');

        $sut = new ViewGameByCompanyIdUseCase($this->getMockForException());
    ...
    {
        $mock = $this->createMock(GameRepository::class);
        $mock->expects(self::never())->method('getGamesByCompanyId')->willReturn([
                new Game(
                    1,
                    "Alex Kidd in Miracle world",
                    "Plataformas",
    ...
    public function testValidLocation()
    {
        ...
        $sut = new ViewGameByCompanyIdUseCase($this->getMockValidLocation());
